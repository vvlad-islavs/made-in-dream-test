...
Recipe _$RecipeFromJson(Map<String, dynamic> json) => Recipe(
  ...
  ingredients: Recipe._ingredientsFromJson(
    Recipe._ingredientsReadValue(json, 'ingredients') as Map<String, dynamic>?,
  ),
...
RecipeStep _$RecipeStepFromJson(Map<String, dynamic> json) => RecipeStep(
  text: json['text'] as String?,
  imageUrl1: json['image1'] as String?,
  imageUrl2: json['image2'] as String?,
);

Map<String, dynamic> _$RecipeStepToJson(RecipeStep instance) =>
    <String, dynamic>{
      'text': instance.text,
      'image1': instance.imageUrl1,
      'image2': instance.imageUrl2,
    };
